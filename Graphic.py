...
class MainPageWindow(QMainWindow, MainPage):
    def __init__(self):
        ...
        self.main_image_gray.setHidden(False)
        self.changed_image_gray.setHidden(False)
        ...
        self.GrayApplyBTN.setHidden(True)
        
        self.Blur_frame.setHidden(True)
        self.BlurApplyBTN.setHidden(True)
        self.main_image_blur.setHidden(True)
        self.changed_image_blur.setHidden(True)
        self.BlurApplyBTN.clicked.connect(self.image_Blur)

        self.Hue_frame.setHidden(True)
        self.HueApplyBTN.setHidden(True)
        self.main_image_hue.setHidden(True)
        self.changed_image_hue.setHidden(True)
        self.HueApplyBTN.clicked.connect(self.image_hue)

        self.noisy_frame.setHidden(True)
        self.HueApplyBTN.setHidden(True)
        self.main_image_noisy.setHidden(True)
        self.changed_image_noisy.setHidden(True)
        self.NoisyApplyBTN.clicked.connect(self.image_noisy)

        self.brightness_frame.setHidden(False)
        self.BrightnessApplyBTN.setHidden(False)
        self.main_image_brightness.setHidden(False)
        self.changed_image_brightness.setHidden(False)
        self.BrightnessApplyBTN.clicked.connect(self.image_brightness)
        ...
        self.GrayApplyBTN.clicked.connect(self.image_gray)
    ...
    def image_gray(self):
        ...
        pix = QPixmap(path)
        pix = pix.scaled(self.changed_image_gray.size())
        self.changed_image_gray.setPixmap(pix)

    def image_Blur(self):
        path=self.myLogicObject.filterBlur(self.myLogicObject.Data[0])
        pix = QPixmap(path)
        pix = pix.scaled(self.changed_image_blur.size())
        self.changed_image_blur.setPixmap(pix)

    def image_hue(self):
        path=self.myLogicObject.hueFilter(self.myLogicObject.Data[0])
        pix = QPixmap(path)
        pix = pix.scaled(self.changed_image_hue.size())
        self.changed_image_hue.setPixmap(pix)

    def image_brightness(self):
        path=self.myLogicObject.changeBrightness(self.myLogicObject.Data[0])
        pix = QPixmap(path)
        pix = pix.scaled(self.changed_image_brightness.size())
        self.changed_image_brightness.setPixmap(pix)

    def image_noisy(self):
        path=self.myLogicObject.noisyFilter(self.myLogicObject.Data[0])
        pix = QPixmap(path)
        pix = pix.scaled(self.changed_image_noisy.size())
    ...
    def noisyFilter_graphic(self):
        ...
        self.NoisyApplyBTN.setHidden(False)
        self.main_image_noisy.setHidden(False)
        self.changed_image_noisy.setHidden(False)
    ...
    def hueFilter_graphic(self):
        ...
        self.gray_frame.setHidden(False)
        self.Blur_frame.setHidden(False)
        self.HueApplyBTN.setHidden(False)
        self.main_image_hue.setHidden(False)
        self.changed_image_hue.setHidden(False)
    ...
    def filterBlur_graphic(self):
        self.gray_frame.setHidden(False)
        self.Blur_frame.setHidden(False)
        self.BlurApplyBTN.setHidden(False)
        self.main_image_blur.setHidden(False)
        self.changed_image_blur.setHidden(False)
